<template>
  <div class="relative w-full min-w-70">
    <div
      @click="toggleDropdown"
      class="flex items-center justify-between px-4 py-2 bg-white border border-gray-300 rounded-lg cursor-pointer hover:border-gray-400 focus-within:border-secondary transition-colors duration-200"
      :class="{ 'border-secondary rounded-b-none!': isOpen }"
    >
      <span 
    ...
    >
      <div
        v-if="isOpen"
        class="absolute top-full left-0 right-0 mt-0 bg-white border border-secondary rounded-b-lg shadow-lg z-50 max-h-60 overflow-y-auto"
      >
        <div
